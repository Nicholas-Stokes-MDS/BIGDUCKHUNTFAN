                    ...
                    if (event.type == sf::Event::MouseButtonPressed)
                    {
                        ...
                        if (PlayerTurn[2].m_ElementVisual.getGlobalBounds().contains(sf::Vector2f(sf::Mouse::getPosition(window))))
                        {
                            ...
                            if (g_iPlayer == 2)
                            {
                                ...
                                pPlayer2->BuffTroops();
                                pPlayer1->BuffTroops();
                                pPlayer2->AttackEnemies(pPlayer1, window);
                                pPlayer1->AttackEnemies(pPlayer2, window);
                                pPlayer1->ResetBuffs();
                                pPlayer2->ResetBuffs();
                                g_iPlayer = 1;
                            }
                            else
                            {
                                ...
                                pPlayer1->BuffTroops();
                                pPlayer2->BuffTroops();
                                pPlayer1->AttackEnemies(pPlayer1, window);
                                pPlayer2->AttackEnemies(pPlayer2, window);
                                pPlayer1->ResetBuffs();
                                pPlayer2->ResetBuffs();
                                g_iPlayer = 2;
                            }
